...
@register_model
def MIL_VT_small_patch16(image_size, pretrained=False, **kwargs):
    model = MILVisionTransformer(
        img_size=image_size, patch_size=16, embed_dim=384, depth=12, num_heads=6, mlp_ratio=4, qkv_bias=True,
