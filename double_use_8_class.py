...
def k_fold_cross_validation_double_use_8_class(device, eyes_dataset, args, workers=2, print_freq=1,
    ...
    for fold, (train_index, test_index) in enumerate(kf.split(eyes_dataset)):  # split
        ...
        # model = DoubleImageModel7Class(num_classes=8, pretrained_path=args.pretrainedModelPath)
        ...
        for e in range(1, epochs + 1):
            ...
            for batch_idx, (left_image, right_image, label_index_2d_int, label_index_2d_float) in enumerate(train_iterator):
                ...
                # print("logit", logit.shape) [batch, 7]
                # print("label_index_2d_float", label_index_2d_float[:, 1:].shape) [batch, 7]
